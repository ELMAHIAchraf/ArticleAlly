...
<div id="loginCon">
    ...
    <form action="editCategory" method="Post">
        <p>Titre</p>
        <input type="hidden" name="cat_id" value="${category.getId()}">
        <input type="text" class="inp" name="title" value="${category.getName()}">
        <p>cat 1</p>
        <textarea name="desc" class="inp" id="textAr">${category.getDescription()}</textarea>
